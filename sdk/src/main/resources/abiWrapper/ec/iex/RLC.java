...
public class RLC extends Contract {
    ...
    public static final String FUNC_FORCEAPPROVE = "forceApprove";
    ...
    public static final String FUNC_FORCEBURN = "forceBurn";
    ...
    static {
        ...
        _addresses.put("1", "0x607F4C5BB672230e8672085532f7e901544a7375");
        _addresses.put("3", "0x7314dc4d7794b5e7894212ca1556ae8e3de58621");
        _addresses.put("4", "0xf1e6ad3a7ef0c86c915f0fedf80ed851809bea90");
        _addresses.put("42", "0xc57538846ec405ea25deb00e0f9b29a432d53507");
        _addresses.put("31", "0x88b37ff3c0df0692f982a28099a9999c4a422293");
    }
    ...
    public static RemoteCall<RLC> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String faucetAgent1, String faucetAgent2, String faucetAgent3) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(faucetAgent1), 
                new org.web3j.abi.datatypes.Address(faucetAgent2), 
                new org.web3j.abi.datatypes.Address(faucetAgent3)));
        return deployRemoteCall(RLC.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    public static RemoteCall<RLC> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, String faucetAgent1, String faucetAgent2, String faucetAgent3) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(faucetAgent1), 
                new org.web3j.abi.datatypes.Address(faucetAgent2), 
                new org.web3j.abi.datatypes.Address(faucetAgent3)));
        return deployRemoteCall(RLC.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }
